...
const PLATFORM_TINT = {
  ...
  jiocinema: 'bg-rose-700/95 text-white border-transparent',
  zee5: 'bg-fuchsia-700/95 text-white border-transparent',
  sonyliv: 'bg-teal-700/95 text-white border-transparent',
  mxplayer: 'bg-orange-700/95 text-white border-transparent',
  aha: 'bg-amber-600/95 text-black border-transparent',
  erosnow: 'bg-pink-600/95 text-white border-transparent',
